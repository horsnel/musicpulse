...
const FOOTER_COLS = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Bandcamp Best Selling', href: '/trending' },
      { label: 'Audiomack Trending',  href: '/trending' },
      { label: 'Genius Lyrics',       href: '/trending' },
      { label: 'iHeartRadio Charts',  href: '/trending' },
