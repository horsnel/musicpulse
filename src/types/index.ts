...
// ─── CHART ENTRY ───────────────────────────────────────────────
export type Platform = 'spotify' | 'apple' | 'youtube' | 'shazam' | 'billboard' | 'deezer' | 'bandcamp' | 'audiomack' | 'genius' | 'musixmatch' | 'iheart' | 'melon' | 'oricon'
...
// ─── TRENDING ──────────────────────────────────────────────────
export type TrendingPlatform = 'tiktok' | 'twitter' | 'youtube' | 'spotify' | 'apple' | 'soundcloud' | 'billboard' | 'deezer' | 'bandcamp' | 'audiomack' | 'genius' | 'musixmatch' | 'iheart' | 'melon' | 'oricon'
