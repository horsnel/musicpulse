    ...
    return (
      <div className="relative z-10">
        <div className="relative overflow-hidden" style={{ minHeight: '520px' }}>
          ...
          <div className="relative z-10 max-w-[1200px] mx-auto px-6 pt-[48px] pb-[48px] grid gap-10 items-end" style={{ gridTemplateColumns: '280px 1fr' }}>
            {/* Album art skeleton */}
            <div className="w-[280px] h-[280px] rounded-[20px] bg-[var(--bg3)] animate-pulse" />
            {/* Meta skeleton */}
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-3 mt-4">
                ...
                <div className="h-12 w-32 rounded-full bg-[var(--bg3)] animate-pulse" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1200px] mx-auto px-6 my-7">
          <div className="grid grid-cols-5 gap-px bg-[var(--bg3)] rounded-[16px] overflow-hidden h-24" />
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="relative z-10 flex flex-col items-center justify-center min-h-[60vh] px-6">
        <div className="mp-card p-10 text-center max-w-md">
          ...
          <h2 className="text-[20px] font-bold text-[var(--text)] mb-2">Song Not Found</h2>
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-5">
              <a href={`/artists/${displayArtist.toLowerCase().replace(/\s+/g, '-')}`}
                ...
                <span className="text-[13px] font-semibold text-[var(--text)]">{displayArtist}</span>
              </a>
            </div>
        ...
        <div className="grid border border-[var(--border)] rounded-[16px] overflow-hidden"
          ...
          {statStrip.map((s, i) => (
            <div key={s.label}
              ...
              <div className="text-[22px] font-black tracking-[-0.03em]" style={{ color: i === 0 ? 'var(--gold)' : 'var(--text)' }}>{s.value}</div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="mp-card">
            ...
            <div className="p-[22px]">
              ...
              <div className="grid items-center border-b border-[var(--border)] last:border-0"
                style={{ gridTemplateColumns: '1fr 80px 80px 60px 80px' }}>
                <div className="flex items-center gap-2 py-3 text-[12.5px] font-semibold">
                  <MiniPlatformIcon platform={song.platform as any} size={14} />
                  {song.platform.charAt(0).toUpperCase() + song.platform.slice(1)}
                </div>
                <div className="text-[13px] font-black" style={{ color: song.rank === 1 ? 'var(--gold)' : 'var(--green)' }}>#{song.rank}</div>
                ...
                <div className="text-[12px] font-semibold text-[var(--text2)]">{song.isNew ? '1w' : `${Math.floor(Math.random() * 12 + 4)}w`}</div>
                <div className="text-[12px] font-semibold text-[var(--text3)]">{formatCount(song.metric)} {song.metricUnit}</div>
              </div>
            </div>
          </div>
